...
struct RegistrationCompanyView: View {

    @StateObject var viewModel = RegistrationCompanyViewModel()
        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                GTextView(placeholder: "상세 설명", text: $viewModel.content)
                    .frame(height: 223)
                GFillButton(title: "등록하기", action: viewModel.registrationCompany)
            }
            .photoPicker(
